...
const ru = {
  ...
  AMBIENT_DECK_XXX_INVESTOR: { text: ['НАША ПИТЧ-ДЕКА НА ПОРНОСАЙТЕ!!', 'НЕ СПРАШИВАЙ, ОТКУДА Я ЗНАЮ.', 'ОБЪЯСНИТЕСЬ НЕМЕДЛЕННО!!!'], left: 'Сказать, что ошибка', right: 'Стоять на хайпе' },
