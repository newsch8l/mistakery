...
const ru = {
  ...
  AGENT_06_LEGAL: { text: ['Наши юристы увидели в презентации «разумных сотрудников».', 'Покупать их — рабство. Удалите души или эвакуируйте их бесплатно.'], left: 'Удалить души', right: 'Оставить разумными' },
