...
const ru = {
  ...
  PRESS_CAPITALISM: { text: ['патч эмпатии уже работает', 'каждый потенциальный клиент теперь получает три повторных сообщения и личное извинение за капитализм'], left: 'Оставить извинения', right: 'Убрать извинения' },
};
