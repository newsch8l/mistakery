...
const ru = {
  ...
  AMBIENT_CHAIR_STANDOFF: { text: ['не работаю, пока не будет нормального кресла. моё скрипит.', 'нужно то анатомическое за $900.', 'у меня есть позвоночник. у компании, видимо, нет'], left: 'Купить кресло', right: 'Прислать подушку' },
  ...
  AMBIENT_DECK_XXX: { text: ['закинула нашу деку на порносайт — техноинвесторы туда тоже заходят 😌', 'трафик сейчас БЕЗУМНЫЙ.', 'не благодари'], left: 'Оставить', right: 'Удалить' },
  AMBIENT_DECK_XXX_INVESTOR: { text: ['МОЙ ПРИЯТЕЛЬ ТОЛЬКО ЧТО НАШЁЛ НАШ ПИТЧ НА ПОРНОСАЙТЕ!!', 'ОБЪЯСНИТЕСЬ НЕМЕДЛЕННО!!!'], left: 'Сказать, что ошибка', right: 'Стоять на хайпе' },
  ...
  AMBIENT_MOM_FAMILY: { text: ['Теперь вся родня знает, что ты в секте.', 'Мы собрали денег тебя вытащить — тётя Вера уже внесла $2000.', 'Приезжай домой, и они твои ❤️❤️'], left: 'Взять деньги', right: 'Признаться' },
};
